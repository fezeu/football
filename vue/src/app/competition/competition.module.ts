...
@NgModule({
  ...
  declarations: [MainComponent, InitComponent, EquipesComponent, ArbitreComponent, JoueurComponent, MenuComponent, PhasePouleComponent, MatchComponent, QuartComponent, DemiComponent],
