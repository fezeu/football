...
exports.intit = function(req,res){
    if(typeof(req.session.auth) == 'undefined'){
        ...
        if(autre){
         ...
         Tournois.updateOne({'_id':req.body.id},{nom:req.body.nom,situation:req.body.situation,reglement:req.body.reglement,organisateurs:req.body.organisateurs,status:'incomplet'},function(err,resultat){
            if(err){
